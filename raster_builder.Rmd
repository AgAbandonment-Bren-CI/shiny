...
```{r}
# ABANDONMENT 
ssp1 <- rast(here("data", "chen", "SSP1_abandoned_cropland_global.tif"))
ssp2 <- rast(here("data", "chen", "SSP2_abandoned_cropland_global.tif"))
ssp3 <- rast(here("data", "chen", "SSP3_abandoned_cropland_global.tif"))
ssp4 <- rast(here("data", "chen", "SSP4_abandoned_cropland_global.tif"))
ssp5 <- rast(here("data", "chen", "SSP5_abandoned_cropland_global.tif"))
...
ssp1_aggregate <- aggregate(ssp1, fact = abandon_factor, fun = sum)
...
writeRaster(carbon_resamp, filename = "data/carbon/carbon_50k.tif", overwrite = TRUE)
